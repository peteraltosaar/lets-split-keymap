...
#define WMOD MO(_WMOD)
#define TOGWIN TG(_WINDOWS)
...
#define F_WNAV LT(WNAV, KC_F)
#define D_WMOD LT(WMOD, KC_D)
...
#define BSP_WWRD LCTL(KC_BSPC)
#define DEL_WWRD LCTL(KC_DEL)
...
[_QWERTY] = LAYOUT( \
     TAB_ADJ,     KC_Q,     KC_W,     KC_E,     KC_R,     KC_T,         KC_Y,     KC_U,     KC_I,     KC_O,     KC_P,  KC_BSPC, \
      ESCAPE,     KC_A,     KC_S,    D_MOD,    F_NAV,     KC_G,         KC_H,     KC_J,     KC_K,     KC_L,  KC_SCLN,  KC_QUOT, \
 ...
 */
[_LOWER] = LAYOUT( \
     KC_TILD,  KC_EXLM,    KC_AT,  KC_HASH,   KC_DLR,  KC_PERC,      KC_CIRC,  KC_AMPR,  KC_ASTR,  KC_LPRN,  KC_RPRN,   TOGWIN, \
 ...
 */
[_RAISE] = LAYOUT( \
      KC_GRV,     KC_1,     KC_2,     KC_3,     KC_4,     KC_5,         KC_6,     KC_7,     KC_8,     KC_9,     KC_0,  TOGGAME, \
 ...
 * |         |         |         |         |         |         |   |         |         |   Up    |         |         |         |
 * |---------+---------+---------+---------+---------+---------|   |---------+---------+---------+---------+---------+---------|
 * |         |         |         |         |         |         |   |Ctl+Left |  Left   |  Down   |  Right  |Ctl+Right|         |
 * |---------+---------+---------+---------+---------+---------|   |---------+---------+---------+---------+---------+---------|
 * |         |         |         |         |         |         |   |         |  Home   |         |  End    |         |         |
 * |---------+---------+---------+---------+---------+---------|   |---------+---------+---------+---------+---------+---------|
 * |         |         |         |         |         |         |   |         |         |         |         |         |         |
...
[_WNAV] =  LAYOUT( \
     _______,  _______,  _______,  _______,  _______,  _______,      _______,  _______,    KC_UP,  _______,  _______,  _______, \
     _______,  _______,  _______,  _______,    F_NAV,  _______,      CTLLEFT,  KC_LEFT,  KC_DOWN,  KC_RGHT,  CTLRGHT,  _______, \
...
[_WMOD] =  LAYOUT( \
     _______,  _______,  _______,  _______,  _______,  _______,      _______,  _______,  _______,  _______,  _______,  _______, \
     _______,  _______,  _______,    D_MOD,  _______,  _______,     BSP_WWRD,  KC_BSPC,  _______,   KC_DEL, DEL_WWRD,  _______, \
     _______,  _______,  _______,  _______,  _______,  _______,      _______,  _______,  _______,  _______,  _______,  _______, \
     _______,  _______,  _______,  _______,  _______,  _______,      _______,  _______,  _______,  _______,  _______,  _______  \
),
...
[_GAME] =  LAYOUT( \
      ...
      KC_ESC,  _______,  _______,     KC_D,     KC_F,  _______,      _______,  _______,  _______,  _______,  _______,  _______, \
     _______,  _______,  _______,  _______,  _______,  _______,      _______,  _______,  _______,  _______,  _______,  _______, \
     _______,  _______,  _______,  _______,  _______,  _______,      _______,  _______,  _______,  _______,  _______,  _______  \
),
...
[_WINDOWS] =  LAYOUT( \
      KC_TAB,  _______,  _______,  _______,  _______,  _______,      _______,  _______,  _______,  _______,  _______,  _______, \
      KC_ESC,  _______,  _______,   D_WMOD,   F_WNAV,  _______,      _______,  _______,  _______,  _______,  _______,  _______, \
     _______,  _______,  _______,  _______,  _______,  _______,      _______,  _______,  _______,  _______,  _______,  _______, \
     _______,  _______,  _______,  _______,  _______,  _______,      _______,  _______,  _______,  _______,  _______,  _______  \
)
